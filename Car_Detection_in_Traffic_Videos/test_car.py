...
import cv2
import numpy as np
from src.post_car import post_processing
...
def get_args():
    ...
    parser.add_argument("--test_set", type=str, default="custom",
...
def test(opt):
    ...
    for id in image_ids:
        ...
        for pred in predictions:
            ...
            cv2.rectangle(output_image, (xmin, ymin), (xmin + text_size[0] + 3, ymin + text_size[1] + 4), (0,0,255), -1)
            cv2.putText(
